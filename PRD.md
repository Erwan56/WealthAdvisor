...
| **Enveloppe** | Contenant de Lignes avec métadonnées propres (libellé, type, date d'ouverture, statut) — PEA/PEA-PME/CTO, contrat AV/PER, fonds PE/SCPI, portefeuille crypto par plateforme. **Liquidités et Immobilier n'ont pas d'Enveloppe** : Lignes autonomes. |
